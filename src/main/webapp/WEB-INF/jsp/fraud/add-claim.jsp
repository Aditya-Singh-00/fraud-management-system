...
<head>
    <title>Add Claim Fraud</title>
</head>

<body>
    <h1>Add a claim fraud</h1>
    <a href="/logout">Logout</a>
    <form method="post" modelAttribute="claim">
        <label>Card No.</label>
        <input type="text" name="cardNo" placeholder="Enter your card no." required />
        <label>User Id</label>
        <input type="text" name="userId" placeholder="Enter user id." required />
        <label>Claim Holder Name</label>
        <input type="text" name="cardHolderName" placeholder="Enter claim holder name." required />
